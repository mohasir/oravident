...
import { genderEnum } from '@core/db/enums.ts';
...
export type PatientTable = typeof patients;
export type PatientColumn = keyof PatientSelect;

export type PatientSelect = typeof patients.$inferSelect;
export type PatientInsert = typeof patients.$inferInsert;
export type PatientUpdate = Partial<Omit<PatientInsert, 'id' | 'createdAt'>>;
