...
export const clinics = pgTable('clinics', {
  ...
  timeZone: varchar('timezone', { length: DB_LIMITS.TIMEZONE })
...
export type ClinicTable = typeof clinics;
export type ClinicColumn = keyof ClinicSelect;

export type ClinicSelect = typeof clinics.$inferSelect;
export type ClinicInsert = typeof clinics.$inferInsert;
export type ClinicUpdate = Partial<Omit<ClinicInsert, 'id' | 'createdAt'>>;
