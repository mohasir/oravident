CREATE TYPE "public"."action_source" AS ENUM('WEB_ADMIN', 'MOBILE_IOS', 'MOBILE_ANDROID', 'WHATSAPP', 'SYSTEM');--> statement-breakpoint
CREATE TYPE "public"."contract_type_enum" AS ENUM('FULL_TIME', 'PART_TIME', 'CONTRACTOR');--> statement-breakpoint
...
CREATE TABLE "workers" (
	...
	"contract_type" "contract_type_enum" DEFAULT 'FULL_TIME',
	"is_active" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE "appointment_status_history" ADD CONSTRAINT "appointment_status_history_status_id_appointment_statuses_id_fk" FOREIGN KEY ("status_id") REFERENCES "public"."appointment_statuses"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appointment_status_history" ADD CONSTRAINT "appointment_status_history_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_invitations" ADD CONSTRAINT "user_invitations_clinic_id_clinics_id_fk" FOREIGN KEY ("clinic_id") REFERENCES "public"."clinics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "appointment_history_id_idx" ON "appointment_status_history" USING btree ("appointment_id");--> statement-breakpoint
CREATE INDEX "appointment_history_created_idx" ON "appointment_status_history" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "appointments_branch_idx" ON "appointments" USING btree ("branch_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "clinic_email_idx" ON "user_invitations" USING btree ("clinic_id","email");--> statement-breakpoint
CREATE UNIQUE INDEX "worker_branch_idx" ON "worker_branches" USING btree ("worker_id","branch_id");--> statement-breakpoint
CREATE UNIQUE INDEX "worker_schedule_idx" ON "worker_schedules" USING btree ("worker_id","branch_id","day_of_week");--> statement-breakpoint
CREATE UNIQUE INDEX "worker_clinic_user_idx" ON "workers" USING btree ("clinic_id","user_id");