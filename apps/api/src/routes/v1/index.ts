...
import doctorsRoutes from '@modules/workers/doctors/doctors.routes.ts';
import receptionistsRoutes from '@modules/workers/receptionists/receptionists.routes.ts';
...
v1Router.use('/receptionists', receptionistsRoutes);
